...
class VerbSemanticsBaseline1(TextTrainer):
    """
    ...
    def __init__(self, params: Params):
        ...
        super(VerbSemanticsBaseline1, self).__init__(params)
    ...
    def _build_model(self):
        ...
        for i in range(self.num_stacked_rnns):
            ...
            # shape still (batch_size, text_length, 2*embedding_dim)
        ...
        #                          activation='softmax', name="state_change")(verb_entity_vector)
    ...
    def _get_custom_objects(cls):
        custom_objects = super(VerbSemanticsBaseline1, cls)._get_custom_objects()
