...
class VerbSemanticsBaseline2(TextTrainer):
    """
    ...
    def __init__(self, params: Params):
        ...
        super(VerbSemanticsBaseline2, self).__init__(params)
    ...
    def _build_model(self):
        ...
        verb_input = Input(shape=self._get_sentence_shape(), dtype='float32', name='verb_array_input')
        ...
        # embedding(word) = embedding + bit for verb + bit for entity
        ...
        # merged_sentence_vector shape is (batch_size, text_length, embedding_dim+2)

        print("++++++++", merged_sentence_vector)
        ...
        for i in range(self.num_stacked_rnns):
            ...
            print("Inside _build_model:", merged_sentence_vector)
            merged_sentence_vector = encoder(merged_sentence_vector)
            print("encoded ", i, " ++++++++", merged_sentence_vector)

        print("encoded ++++++++", merged_sentence_vector)
        ...
        state_change_type = Dense(self.data_indexer.get_vocab_size("state_changes") - 2,
                                  activation='softmax', name="state_change")(averaged_sentence_vector)
    ...
    def _get_custom_objects(cls):
        custom_objects = super(VerbSemanticsBaseline2, cls)._get_custom_objects()
